...
<div class="view rgba-gradient ">
    ...
    <div class="col rgba-gradient">
        <div class="d-flex justify-content-center align-items-center">
            ...
            <a href="/admin/admin/adminchik/create" type="button" class="btn btn-success btn">Add new part</a>
            </p>
        </div>
        <div class="d-flex justify-content-center align-items-center">
            <p>
                    ...
                    <div class="container">
                        <table class="table table-striped table-dark">
                            <tr>
                                ...
                                <th scope="col">
                                    <a href="/admin/admin/adminchik/adding" type="button" class="btn btn-success">
                                        Add
                                    </a>
                                </th>
                            </tr>
